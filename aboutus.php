...
$query=mysqli_query($con,"select  tblvendor.restaurantName,tblvendor.fldvendor_id,tblvendor.fld_email,tblvendor.vendorMobile,tblvendor.restaurantAddress,tblvendor.restaurant_Image,tbfood.food_id,tbfood.foodname,tbfood.cost,tbfood.cuisines,tbfood.paymentmode from tblvendor inner join tbfood on tblvendor.fldvendor_id=tbfood.fldvendor_id;");
...
<div class="container-fluid">
  <img src="img/about-us.webp" width='100%' height="90%">
</div>
<br><br>
