...
{
    $q=mysqli_query($con,"select * from tbfood where food_id='$fid'");
    ...
    if(mysqli_query($con,"delete from tbfood where food_id='$fid' "))
    {
        unlink("image/restaurant/$email/foodimages/$img");
