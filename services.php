...
$query=mysqli_query($con,"select  tblvendor.restaurantName,tblvendor.fldvendor_id,tblvendor.fld_email,tblvendor.restaurantMobile,tblvendor.restaurantAddress,tblvendor.restaurant_Image,tbfood.food_id,tbfood.foodname,tbfood.cost,tbfood.cuisines,tbfood.paymentmode 
...
<div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="d-block w-100" src="img/Customer-Support.jpg" alt="First slide" width="100%" height="100%">
