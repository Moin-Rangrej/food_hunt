...
<div class="container">
	   ...
	   <ul class="nav nav-tabs nabbar_inverse" id="myTab" style="background:#ED2553;border-radius:10px 10px 10px 10px;" role="tablist">
          <li class="nav-item">
             <a class="nav-link active" style="color:#000000;" id="viewitem-tab" data-toggle="tab" href="#viewitem" role="tab" aria-controls="viewitem" aria-selected="true">View Food Items</a>
          </li>
		  		<li class="nav-item">
              <a class="nav-link" style="color:#000000;"  id="ManageVendors-tab" data-toggle="tab" href="#ManageVendors" role="tab" aria-controls="ManageVendors" aria-selected="false">Manage Restaurant</a>
          </li>
		  		<li class="nav-item">
              <a class="nav-link" style="color:#000000;" id="orderstatus-tab" data-toggle="tab" href="#orderstatus" role="tab" aria-controls="orderstatus" aria-selected="false">Order Status</a>
          </li>
          <li class="nav-item">
...
<!--tab 1 ends-->	   
			...
			<!--tab 2 ends-->
			 ...
			 <?php
				...
				{
 					$id=$_SESSION['id'];
					$income = mysqli_query($con,"select tblorder.fld_payment from tblorder inner join tblvendor on tblvendor.fldvendor_id=tblorder.fldvendor_id where tblvendor.fld_email='$id'");
            ...
            // $sql = "count(fldvendor_id) as Total_Restaurant from tblvendor";
					...
					// $sql = "select tblvendor.restaurantName,tblvendor.fldvendor_id,tblvendor.fld_email,
            		...
            		echo '<h1>'.$total.'&nbsp;&nbsp;Restaurant Register</h1>'; 
        			?>
    				</div>
    			</div> 
				<br><br>  
	               <table class="table">
						...
						<tr>
							<th scope="col"></th>
							<th scope="col">Restaurant/vendor ID</th>
	...
	?>			 
                    ...
                    <tr>
                        ...
                        <?php
							$venid = $row['restaurantAddress'];
						?>
                           
						<form method="post">
                        <td><a href="#"  style="text-decoration:none; color:white;" onclick="delRecord(<?php echo $row['fldvendor_id']; ?>)"><button type="button" class="btn btn-danger">Remove</a></a></td>
                        </form>
						<td><?php echo '<h1>'.$total_income.'</h1>';?></td>
                   </tr>
		<?php
		}
		?>		   
