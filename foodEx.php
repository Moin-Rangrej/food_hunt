    ...
    if(!empty($chk)) 
		{
			...
			if(mysqli_query($con,"insert into tbfood(fldvendor_id,foodname,cost,cuisines,paymentmode,fldimage) values('$v_id','$food_name','$cost','$cuisines','$paymentmode','$img_name')"))
			{
	...
	<!--tab 1 starts-->   
	   <div class="tab-content" id="myTabContent">
			...
			<div class="container"> 
			 ...
			 <th>Update Food</th>
			   	<?php
					  if($query=mysqli_query($con,"select tblvendor.fldvendor_id,tblvendor.fld_email,tbfood.food_id,tbfood.foodname,tbfood.cost,tbfood.paymentmode,tbfood.cuisines,tbfood.fldimage,tblvendor.restaurantName from tblvendor inner join tbfood on tblvendor.fldvendor_id=tbfood.fldvendor_id where tblvendor.fld_email='$id'"))
					  {
						  if(mysqli_num_rows($query))
						  {
         ...
         <!--add Product-->
                  <form action="" method="post" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                      	<label for="cuisines">Food Snaps :</label><br>
...
<!--tab 2 ends-->
			...
			<div class="tab-pane fade" id="logo" role="tabpanel" aria-labelledby="logo-tab">
			 ...
			 <div class="tab-pane fade " id="status" role="tabpanel" aria-labelledby="status-tab">
			   ...
			   ?>
						<form method="post">
						<td><a href="changestatus.php?order_id=<?php echo $orderrow['fld_order_id']; ?>"><button type="button" class="btn btn-primary" name="changestatus">Update Status</button></a>
						<a href="orderdeliver.php?order_id=<?php echo $orderrow['fld_order_id']; ?>"><button type="button" class="btn btn-success" name="changestatus">Assign Delivery Boy</button></a>
						</td>
						</form>
						<tr>
						<?php
