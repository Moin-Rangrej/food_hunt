...
<div class="container">
        <div class="row mt-4">
            ...
            $check_vendor = mysqli_num_rows($query) > 0;
            if ($check_vendor) {
    ...
    <div class="container mt-4">
        <div class="card mt">
            <div class="row">
                ...
                <h3 style="color:black;text-transform:uppercase;"><?php echo $row['restaurantName']; ?></h3>
                ...
                <div class="card-title">
                <span style="color:#A5A5A5;font-size:25px;"><i class="fas fa-phone"></i></span>&nbsp;&nbsp;<span style=" font-size:25px; color:black;"><?php echo $row['restaurantMobile']?></span><br>
                <span style="color:#A5A5A5;font-size:25px;"><i class="fas fa-at"></i></span>&nbsp;&nbsp;<span style=" font-size:25px; color:black;"><?php echo $row['fld_email']?></span>
                </div>
            ...
            <div class="row">
                ...
                <div class="d-flex justify-content-between"> 
                  ...
                  <div class="food-card_order-count">
                      ...
                      <h5 class="card-text">cost:<?php echo $row['cost']; ?></h5>
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      <h1 style="font-size: 18px; font-weight:bolder" class="badge badge-success"><?php echo $row['cuisines']; ?></h1>
