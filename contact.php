...
tblvendor.restaurantMobile,tblvendor.restaurantAddress,tblvendor.restaurant_Image,tbfood.food_id,tbfood.foodname,tbfood.cost,tbfood.cuisines,tbfood.paymentmode 
...
<ul class="navbar-nav ml-auto">
    ...
    ?>
        ...
        <li class="nav-item">
            <a class="nav-link active" href="contact.php">Help</a>
        </li>  
        <li class="nav-item">
    ...
    <div class="col-sm-4" style="padding:30px;">
	   <div class="form-group">
           <i class="fa fa-phone" aria-hidden="true"></i>&nbsp;<b>7503515386</b><br><br>
			<i class="fa fa-home" aria-hidden="true"></i>&nbsp; 23-A, Ganesh Complex, S.G. Highway, Sola, Ahmedabad, Gujarat, India-380060<br>(24*7 Days)
