...
<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
    ...
    <a class="navbar-brand" href="index.php"><span style="color:red;font-family: 'Impact', cursive;">Food Hunt</span></a>
	  <?php
			if(!empty($cust_id))
			{
		?>
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      ...
      <ul class="navbar-nav ml-auto">
		...
		<li class="nav-item"><!--hotel search-->
		     <a href="#" class="nav-link"><form method="post" autocomplete="off"><input type="text" name="search_restaurant" id="search_restaurant" placeholder="Search by Restaurants " class="form-control" /></form></a>
		  </li>
          <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link" href="aboutus.php">Offers</a>
        </li>
        <li class="nav-item">
...
<div class="container">
        <div id="myslideshow" class="carousel slide carousel-fade" data-ride="carousel">
            ...
            <div class="carousel-inner" class="min-height:5 0px">
                <div class="carousel-item active">
                    <img src="img/food1.jpg" class="d-block w-100 image-resizes">
                    <div class="carousel-caption d-none d-sm-block">
                        <h4 style="text-align: center;">Delicious food</h4>
                        <p style="text-align: center;">Hello Hello Hello Hello Hello Hello Hello Hello Hello Hello</p>
                    </div>
                </div>
                <div class="carousel-item">
                    <img src="img/food2.jpg" class="d-block image-resizes2">
                    <div class="carousel-caption d-none d-sm-block">
                ...
                <div class="carousel-item">
                    <img src="img/food3.jpg" class="d-block image-resizes2">
                    <div class="carousel-caption d-none d-sm-block">
                        <h4>Delicious food</h4>
                        <p>Hello Hello Hello Hello Hello Hello Hello Hello Hello Hello</p>
                    </div>
                ...
                <div class="carousel-item">
                    <img src="img/food4.jpg" class="d-block image-resizes2">
                    <div class="carousel-caption d-none d-sm-block">
                        <h4>Delicious food</h4>
                        <p>Hello Hello Hello Hello Hello Hello Hello Hello Hello Hello</p>
                    </div>
                ...
                <div class="carousel-item">
                    <img src="img/food5.jpg" class="d-block image-resizes2">
                    <div class="carousel-caption d-none d-sm-block">
                        <h4>Delicious food</h4>
                        <p>Hello Hello Hello Hello Hello Hello Hello Hello Hello Hello</p>
                    </div>
                ...
                <div class="carousel-item">
                    <img src="img/food6.jpg" class="d-block image-resizes2" >
                    <div class="carousel-caption d-none d-sm-block">
                        <h4>Delicious food</h4>
                        <p>Hello Hello Hello Hello Hello Hello Hello Hello Hello Hello</p>
                    </div>  
            ...
            <a href="#myslideshow" class="carousel-control-next" role="button"
            data-slide="next">
                    ...
                    <div class="col-md-3">
                        <div class="card">
                            ...
                            <img class="card-img-top image-resize" src="<?php echo $hotel_logo; ?>"  alt="Restaurant Images">
                                ...
                                <h5><a href="new_search.php?vendor_id=<?php echo $row['fldvendor_id']; ?>"><span style="font-family: 'Miriam Libre', sans-serif; font-size:28px;color:#CB202D;">
                                            <?php echo $row['restaurantName']; ?></span></a></h5>
                                <hr>
                                <h5 class="card-title">Phone_No:<?php echo $row['restaurantMobile']; ?></h5>
                                <p class="card-text">
...
<div class="container-fluid">
  <div class="row">
	...
	<?php
	   $food_id=$arr[0];
	  $query=mysqli_query($con,"select tblvendor.fld_email,tblvendor.restaurantName,tblvendor.vendorMobile,tblvendor.restaurantMobile,tblvendor.restaurantAddress,tblvendor.fldvendor_id,tblvendor.restaurant_Image,tbfood.food_id,tbfood.foodname,tbfood.cost,tbfood.cuisines,tbfood.paymentmode,tbfood.fldimage from tblvendor inner join tbfood on tblvendor.fldvendor_id=tbfood.fldvendor_id where tbfood.food_id='$food_id'");
	  ...
	  <div class="container-fluid">
		 ...
		 <?php echo $res['restaurantName']; ?></span></a>
        </div>
	...
	<div class="row"><!--main row-->
		...
		<br><br><br><br><br><br><br><br><br><br><br><br>
			<div class="container-fluid rounded" style="border:solid 1px #F0F0F0;"><!--product container-->
				<?php
					$food_id=$arr[1];
					$query=mysqli_query($con,"select tblvendor.fld_email,tblvendor.restaurantName,tblvendor.vendorMobile,tblvendor.restaurantMobile,tblvendor.restaurantAddress,tblvendor.restaurant_Image,tbfood.food_id,tbfood.foodname,tbfood.cost,tbfood.cuisines,tbfood.paymentmode,tbfood.fldimage from tblvendor inner join tbfood on tblvendor.fldvendor_id=tbfood.fldvendor_id where tbfood.food_id='$food_id'");
				...
				<div class="container-fluid">
					<div class="container-fluid"><!--product row container 1-->
						...
						<div class="col-sm-2"><img src="<?php echo $hotel_logo; ?>" class="rounded-circle" height="50px" width="50px" alt="Cinque Terre"></div>
							<!--hotelname--> 
							<div class="col-sm-5"> <span style="font-family: 'Miriam Libre', sans-serif; font-size:28px;color:#CB202D;"><?php echo $res['restaurantName']; ?></span>
							</div>
							<!--ruppee-->      
							<div class="col-sm-3"><i style="font-size:20px;" class="fas fa-rupee-sign"></i>&nbsp;<span style="color:green; font-size:25px;"><?php echo $res['cost'];?></span></div>
